...
class MyCudaFAST : public MyFeature2D
{
protected:
	cv::Ptr<cv::cuda::FastFeatureDetector> mFeature2D;

public:

	MyCudaFAST() : MyFeature2D()
	{
		mFeature2D = cv::cuda::FastFeatureDetector::create(20, false);
	}
